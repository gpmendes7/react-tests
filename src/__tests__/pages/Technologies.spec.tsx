...
describe('Testing Technologies Page', () => {
    ...
    it('should be able to delete one tech', () => {
        ...
        const itemButtom = screen.getByTestId('React Native-btn-delete')
        userEvent.click(itemButtom)

        expect(screen.queryByTestId('React Native')).toBeNull()
    })

    // Botão delete deve estar desabilitado apenas para a tecnologia React
